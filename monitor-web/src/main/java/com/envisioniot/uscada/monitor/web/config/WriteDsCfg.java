...
@MapperScan(basePackages = {"com.envisioniot.uscada.monitor.web.mapper.fdb.write"},
...
public class WriteDsCfg {
    ...
    public SqlSessionFactory sqlSessionFactoryW(@Qualifier("dataSourceW") DataSource dataSource) {
        ...
        factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/fdb/write/*Mapper.xml"));
