...
public interface TopoFWMapper {

    /**
     * 插入拓扑单元--部署了Agent的主机
     * @param hostIp
     */
    int insHost_update_first(@Param("hostIp") String hostIp);

    /**
     * 插入拓扑单元--部署了Agent的主机
     * @param hostIp
     */
    void insHost_insert_iffail(@Param("hostIp") String hostIp);
     ...
     * @param list
     */
    void insDefRelaByHost_update_first(@Param("hostIp") String hostIp,
                                       @Param("list") List<TopoRelaInfo> list);
     ...
     * @param list
     */
    void insDefRelaByHost_insert_later(@Param("hostIp") String hostIp,
                                       @Param("list") List<TopoRelaInfo> list);
